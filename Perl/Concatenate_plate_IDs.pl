...
print NEWFILE 'Plate_ID_date,Plate_ID_number,Well_number,Row,Column,Cell_line,Vial,Passage,Start,Induction_protocol,NPC_stock,Stock_date,Wake_date,Suspension,Condition_1,Condition_2,Condition_3,Condition_4,Condition_5,Experiment_day,Treatment,Replicate', "\n";
