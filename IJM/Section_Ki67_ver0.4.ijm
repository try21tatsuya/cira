...
function processFile(d) {
	...
	run("Subtract Background...", "rolling=200 sliding"); //やっぱり緩めに	
	...
	run("Subtract Background...", "rolling=200 sliding"); //200に緩める
	...
	// EpCAM陽性LTL陽性
	imageCalculator("AND create", "CH3_bin.tif", "CH2_bin.tif"); //CH2がEpCAMRb
	...
	// EpCAM陽性中のHoechst
	imageCalculator("AND create", "CH1_bin.tif", "CH2_bin.tif");
	...
	// EpCAM陽性中のKi67
	imageCalculator("AND create", "CH2_bin.tif", "CH4_bin.tif");
	...
	// EpCAM陽性LTL陽性中のKi67
	imageCalculator("AND create", "CH4_bin.tif", "CH5_bin.tif");
